...
document.querySelectorAll(".nava").forEach(function (e) {
  e.addEventListener("mousemove", function (dets) {
    e.querySelector("h1:nth-child(1)").style.transform = "translateY(-100%)";
    e.querySelector("h1:nth-child(2)").style.transform = "translateY(-100%)";
...
document.querySelector("#p61").addEventListener("mousemove", function (dets) {
  gsap.to(".p1 .char", {
    y: -125,
    stagger: 0.05,
  });
});
document.querySelector("#p61").addEventListener("mouseleave", function (dets) {
  gsap.to(".p1 .char", {
    y: 0,
    stagger: 0.05,
  });
});
document.querySelector("#p62").addEventListener("mousemove", function (dets) {
  gsap.to(".p2 .char", {
    y: -355,
    stagger: 0.05,
  });
});
document.querySelector("#p62").addEventListener("mouseleave", function (dets) {
  gsap.to(".p2 .char", {
    y: -100,
    stagger: 0.05,
  });
...
document.querySelector("#p63").addEventListener("mousemove", function (dets) {
  gsap.to(".p3 .char", {
    y: -125,
    stagger: 0.05,
  });
});
document.querySelector("#p63").addEventListener("mouseleave", function (dets) {
  gsap.to(".p3 .char", {
    y: 0,
    stagger: 0.05,
  });
});
document.querySelector("#p64").addEventListener("mousemove", function (dets) {
  gsap.to(".p4 .char", {
    y: -355,
    stagger: 0.05,
  });
});
document.querySelector("#p64").addEventListener("mouseleave", function (dets) {
  gsap.to(".p4 .char", {
    y: -100,
    stagger: 0.05,
  });
